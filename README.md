...
```text
MLXServerManager-v7.2.1-unsigned.zip
```
...
`v7.2.1` is the latest app-code release. Recent v6 documentation releases do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: b9443d5916594403761930296ab399371201d98a2845deba5b59b0ddc44e3423
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v7.2.1-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v7.2.1-unsigned.zip` release asset.
