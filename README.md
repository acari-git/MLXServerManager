...
`v7.0.0` is the latest app-code release. Recent v6 documentation releases do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: 3d8cc9f111a90f7021b070ba97748846e7b41d9fc253ff85c51e38e3dd2d15a4
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v7.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v7.0.0-unsigned.zip` release asset.
