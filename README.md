...
```text
MLXServerManager-v7.1.0-unsigned.zip
```
...
`v7.1.0` is the latest app-code release. Recent v6 documentation releases do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: 44ac8e0db4768b79995cef7a7000033ed79017b4743ec6afeaf358bc7749baee
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v7.1.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v7.1.0-unsigned.zip` release asset.
