...
```text
MLXServerManager-v10.0.0-unsigned.zip
```
...
`v10.0.0` is the latest app-code release. Recent v6/v7/v8/v9 staged commits do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: e78747a79e3bc5385132cfc5fb7b01bd04b1c6e2efbe317b68ebced11f0f2360
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v10.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v10.0.0-unsigned.zip` release asset.
