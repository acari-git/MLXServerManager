...
```text
MLXServerManager-v8.0.0-unsigned.zip
```
...
`v8.0.0` is the latest app-code release. Recent v6/v7 documentation-only releases do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: 8862eef65a0960c3887a616f6066c4fa735067a271b89839fb01d134baa80d21
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v8.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v8.0.0-unsigned.zip` release asset.
