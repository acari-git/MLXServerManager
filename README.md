...
Metrics / System Context design is documented in [docs/metrics_system_context.md](docs/metrics_system_context.md). v6.5.0 implements the first Metrics / System Context surface as a read-only top-level sidebar destination; it does not implement active system monitoring, system monitoring, telemetry, request inspection, or behavior changes.
