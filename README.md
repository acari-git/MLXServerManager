...
```text
MLXServerManager-v12.0.0-unsigned.zip
```
...
`v12.0.0` is the latest app-code release. Recent v6/v7/v8/v9/v10/v11 staged commits do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: 7361c6c63a5ff7a3505bd338eb5a919b9eb609f33faf10dd454a33c7902f3539
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v12.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v12.0.0-unsigned.zip` release asset.
