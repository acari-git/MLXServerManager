...
See `docs/` and `contracts/` for requirements, architecture, UI, testing, and behavioral contracts. Before publishing or distributing v0.1, use the [v0.1 release verification checklist](docs/v0.1_checklist.md). For the v0.2 Setup Diagnostics plan, see [docs/v0.2_plan.md](docs/v0.2_plan.md) and [docs/setup_diagnostics.md](docs/setup_diagnostics.md). For the v0.3 Model profile editing plan, see [docs/v0.3_plan.md](docs/v0.3_plan.md) and [docs/model_profile_editing.md](docs/model_profile_editing.md). For the v0.4 Menu bar quick actions plan, see [docs/v0.4_plan.md](docs/v0.4_plan.md) and [docs/menu_bar_quick_actions.md](docs/menu_bar_quick_actions.md).
