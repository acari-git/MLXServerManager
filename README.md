...
- `MLXServerManager-v4.3.0-unsigned.zip`

v4.0.0 and v4.1.0 are docs-only preparation releases. v4.2.0 and v4.3.0 are app-code dashboard polish releases with unsigned app zip assets. v4.4.0 also changes app UI code, so it will need a new unsigned app zip when released.
...
As of v4.4.0, MLX Server Manager includes:
