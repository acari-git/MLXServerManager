...
```text
MLXServerManager-v11.0.0-unsigned.zip
```
...
`v11.0.0` is the latest app-code release. Recent v6/v7/v8/v9/v10 staged commits do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: dd0b90f2b665c047acc33a4603b2be7fcbeb8f73421bfe294e7815f52c19e800
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v11.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v11.0.0-unsigned.zip` release asset.
