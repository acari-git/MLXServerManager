...
`v19.0.0` is the latest app-code release. Recent v6/v7/v8/v9/v10/v11/v12/v13/v14/v15/v16/v17/v18 staged commits do not replace this app binary.
...
```sh
shasum -a 256 MLXServerManager-v19.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v19.0.0-unsigned.zip` release asset.
...
v19.0.0 focuses on daily operations recovery. The integrated workspace now classifies runtime/download failures, surfaces recommended recovery actions, provides an integrated Recovery panel, copies troubleshooting summaries, and keeps safety refresh explicit while preserving Direct Mode.
