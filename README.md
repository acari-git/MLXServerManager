...
```text
MLXServerManager-v7.2.0-unsigned.zip
```
...
`v7.2.0` is the latest app-code release. Recent v6 documentation releases do not replace this app binary.
...
```sh
shasum -a 256 MLXServerManager-v7.2.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v7.2.0-unsigned.zip` release asset.
