...
See `docs/` and `contracts/` for requirements, architecture, UI, testing, and behavioral contracts. Before publishing or distributing v0.1, use the [v0.1 release verification checklist](docs/v0.1_checklist.md). For the v0.2 Setup Diagnostics plan, see [docs/v0.2_plan.md](docs/v0.2_plan.md) and [docs/setup_diagnostics.md](docs/setup_diagnostics.md). For the v0.3 Model profile editing plan, see [docs/v0.3_plan.md](docs/v0.3_plan.md) and [docs/model_profile_editing.md](docs/model_profile_editing.md). For the v0.4 Menu bar quick actions plan, see [docs/v0.4_plan.md](docs/v0.4_plan.md) and [docs/menu_bar_quick_actions.md](docs/menu_bar_quick_actions.md). For the v0.5 distribution build plan, see [docs/v0.5_plan.md](docs/v0.5_plan.md) and [docs/distribution_build.md](docs/distribution_build.md). For the v0.6 Model profile management plan, see [docs/v0.6_plan.md](docs/v0.6_plan.md) and [docs/model_profile_management.md](docs/model_profile_management.md). For the v0.7 Model switching plan, see [docs/v0.7_plan.md](docs/v0.7_plan.md) and [docs/model_switching.md](docs/model_switching.md). For the v0.8 Logging and Diagnostics plan, see [docs/v0.8_plan.md](docs/v0.8_plan.md) and [docs/logging_and_diagnostics.md](docs/logging_and_diagnostics.md). For the v0.9 unsigned zip distribution plan, see [docs/v0.9_plan.md](docs/v0.9_plan.md) and [docs/distribution.md](docs/distribution.md).
