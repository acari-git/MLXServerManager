...
```text
MLXServerManager-v13.0.0-unsigned.zip
```
...
`v13.0.0` is the latest app-code release. Recent v6/v7/v8/v9/v10/v11/v12 staged commits do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: 784a02028cc2bf6c576c4ffc811d83ad6ff4a910702cfb29e9058a9571178fce
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v13.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v13.0.0-unsigned.zip` release asset.
