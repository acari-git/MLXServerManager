...
```text
MLXServerManager-v9.0.0-unsigned.zip
```
...
`v9.0.0` is the latest app-code release. Recent v6/v7/v8 staged commits do not replace this app binary.

Verify the checksum before opening the app:

```text
SHA-256: e016bb7fedb047f78e2d6d50f46a59d62e1adbd03381059cd591b16b885f0736
```

From the folder containing the downloaded zip, you can check it with:

```sh
shasum -a 256 MLXServerManager-v9.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v9.0.0-unsigned.zip` release asset.
