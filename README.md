...
`v15.0.0` is the latest app-code release. Recent v6/v7/v8/v9/v10/v11/v12/v13/v14 staged commits do not replace this app binary.
...
```sh
shasum -a 256 MLXServerManager-v15.0.0-unsigned.zip
```
...
Do not download the source archive if you want the app binary. Use the named `MLXServerManager-v15.0.0-unsigned.zip` release asset.
