...
v5.9.0 adds [v6 Implementation Readiness Review](v6_implementation_readiness.md) as a docs-only readiness checkpoint before any future v6 app-code implementation begins. Dashboard v1 remains the current stable surface and should remain available during any future app shell work.
...
- Treat v5.9.0 as the v6 implementation readiness review release.
