...
- future full app layout refresh planning after v5.0.0 finalized Dashboard UI Refresh v1, v5.1.0 clarified the stable follow-up boundary, v5.2.0 documented a candidate v6.x direction in [Full App Layout Refresh Design](full_app_layout_refresh.md), and v5.3.0 detailed the first candidate App Shell / Sidebar Foundation step in [App Shell / Sidebar Foundation Design](app_shell_sidebar_foundation.md),
