...
- dashboard-style UI refresh, with v4.1.0 design guidance, v4.2.0 foundation work, v4.3.0 Current Target polish, v4.4.0 Server State polish, v4.5.0 Logs / Diagnostics guidance polish, v4.6.0 Profiles / Import Export polish, v4.7.0 Onboarding / Next Steps polish, v4.8.0 Layout / Information Hierarchy polish, and v4.9.0 Copy / Client Setup polish in [Dashboard UI Refresh Design](dashboard_ui_refresh.md),
